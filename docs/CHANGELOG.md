## 2026-04-07（WXG 微信小店面试：新增 voice_assistant 项目介绍手稿）

### ✨ 新增内容
- 新增面试讲稿：`面试项目介绍手稿_voice_assistant.md`，用于 5–10 分钟介绍本项目（亮点/难点/与 openclaw 对比口径）。

### 📝 修改的文件
| 文件 | 修改内容 |
|------|----------|
| `面试项目介绍手稿_voice_assistant.md` | 新增：WXG 面试项目介绍手稿 |
| `docs/CHANGELOG.md` | 记录本次新增 |
